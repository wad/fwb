...
public class StatementMove extends Statement {
    ...
    public StatementMove(String code, BasicRunner basicRunner, int lineNumberInFile) throws BasicException {
        ...
        unevaluatedArguments = code.substring(pieces[0].length());
    }
    ...
    public void execute() throws BasicException {
        ...
        getBasicRunner().getTextTerminal().setCursorPosition(getBasicRunner().getKeyboardInput(), row, column);
    }
