...
public class StatementPlot extends Statement {

    private String unevaluatedArguments;

    public StatementPlot(String code, BasicRunner basicRunner, int lineNumberInFile) throws BasicException {
    ...
    public void execute() throws BasicException {
        if (unevaluatedArguments.length() == 0) {
            ...
            getBasicRunner().getGraphicsTerminal().plot(x, y);
        }
    }
