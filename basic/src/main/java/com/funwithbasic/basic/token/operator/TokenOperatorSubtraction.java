...
public class TokenOperatorSubtraction extends TokenOperator {

    public static final char SYMBOL = '-';

    public TokenOperatorSubtraction(BasicRunner basicRunner) {
    ...
    public Token evaluate(List<Token> arguments) throws BasicException {
        ...
        return new TokenValueNumber(ValueNumber.subtract(a, b), basicRunner);
    }
