...
public class TokenOperatorDivision extends TokenOperator {

    public static final char SYMBOL = '/';

    public TokenOperatorDivision(BasicRunner basicRunner) {
    ...
    public Token evaluate(List<Token> arguments) throws BasicException {
        ...
        return new TokenValueNumber(ValueNumber.divide(a, b), basicRunner);
    }
