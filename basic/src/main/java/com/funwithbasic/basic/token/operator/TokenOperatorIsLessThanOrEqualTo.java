...
public class TokenOperatorIsLessThanOrEqualTo extends TokenOperator implements TokenWithArguments {

    public static final String SYMBOL = "<=";

    public TokenOperatorIsLessThanOrEqualTo(BasicRunner basicRunner) {
    ...
    public Token evaluate(List<Token> arguments) throws BasicException {
        ...
        return new TokenValueNumber(new ValueNumber(ValueNumber.isLessThanOrEqualTo(a, b)), basicRunner);
    }
