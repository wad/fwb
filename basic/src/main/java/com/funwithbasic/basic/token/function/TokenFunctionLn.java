...
public class TokenFunctionLn extends TokenFunction {

    public static final String SYMBOL = TokenFunction.Function.LN.getText();

    public TokenFunctionLn(BasicRunner basicRunner) {
    ...
    public Token evaluate(List<Token> arguments) throws BasicException {
        ...
        if (a == 0D) {
            throw new BasicException("Cannot take LN of zero");
        }
        return new TokenValueNumber(new ValueNumber(Math.log(a)), basicRunner);
    }
