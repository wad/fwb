...
public class TokenOperatorModulus extends TokenOperator {

    public static final char SYMBOL = '%';

    public TokenOperatorModulus(BasicRunner basicRunner) {
    ...
    public int getPrecedence() {
        return PRECEDENCE_ORDER_MODULUS;
    }
    ...
    public Token evaluate(List<Token> arguments) throws BasicException {
        ...
        return new TokenValueNumber(ValueNumber.modulus(a, b), basicRunner);
    }
