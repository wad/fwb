...
// Cosine, needs argument in radians
public class TokenFunctionCos extends TokenFunction {

    public static final String SYMBOL = TokenFunction.Function.COS.getText();

    public TokenFunctionCos(BasicRunner basicRunner) {
    ...
    public Token evaluate(List<Token> arguments) throws BasicException {
        ...
        return new TokenValueNumber(new ValueNumber(Math.cos(a)), basicRunner);
    }
