...
// Sine, needs argument in radians
public class TokenFunctionSin extends TokenFunction {

    public static final String SYMBOL = TokenFunction.Function.SIN.getText();

    public TokenFunctionSin(BasicRunner basicRunner) {
    ...
    public Token evaluate(List<Token> arguments) throws BasicException {
        ...
        return new TokenValueNumber(new ValueNumber(Math.sin(a)), basicRunner);
    }
