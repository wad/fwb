...
public class TokenOperatorIsGreaterThan extends TokenOperator implements TokenWithArguments {

    public static final char SYMBOL = '>';

    public TokenOperatorIsGreaterThan(BasicRunner basicRunner) {
    ...
    public Token evaluate(List<Token> arguments) throws BasicException {
        ...
        return new TokenValueNumber(new ValueNumber(ValueNumber.isGreaterThan(a, b)), basicRunner);
    }
